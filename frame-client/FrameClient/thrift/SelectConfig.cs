...
[Serializable]
#endif
public partial class SelectConfig : TBase
{
  ...
  public SelectConfig() {
    this._eventType = NodeEventType.NONE;
        ...
        switch (field.ID)
        {
          case 1:
            if (field.Type == TType.I32) {
              EventType = (NodeEventType)iprot.ReadI32();
            } else { 
  ...
  public void Write(TProtocol oprot) {
    ...
    try
    {
      TStruct struc = new TStruct("SelectConfig");
  ...
  public override string ToString() {
    StringBuilder __sb = new StringBuilder("SelectConfig(");
    bool __first = true;
    if (__isset.eventType) {
