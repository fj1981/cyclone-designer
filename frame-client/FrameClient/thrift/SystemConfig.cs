...
[Serializable]
#endif
public partial class SystemConfig : TBase
{
        ...
        switch (field.ID)
        {
          case 1:
            if (field.Type == TType.I32) {
              EventType = (SystemEventType)iprot.ReadI32();
            } else { 
  ...
  public void Write(TProtocol oprot) {
    ...
    try
    {
      TStruct struc = new TStruct("SystemConfig");
  ...
  public override string ToString() {
    StringBuilder __sb = new StringBuilder("SystemConfig(");
    bool __first = true;
    if (__isset.eventType) {
