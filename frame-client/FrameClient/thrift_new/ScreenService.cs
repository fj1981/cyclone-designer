...
public partial class ScreenService {
  public interface ISync {
    ...
    bool sendDisplay(int width, int height, int barHeight, int scale);
    bool ping(int interval);
    bool getDisplay();
    string sendPoint(int x, int y);
  ...
  public interface Iface : ISync {
    ...
    #endif
    #if SILVERLIGHT
    IAsyncResult Begin_sendDisplay(AsyncCallback callback, object state, int width, int height, int barHeight, int scale);
    ...
    #endif
    #if SILVERLIGHT
    IAsyncResult Begin_sendPoint(AsyncCallback callback, object state, int x, int y);
    string End_sendPoint(IAsyncResult asyncResult);
    #endif
    #if SILVERLIGHT
  ...
  public class Client : IDisposable, Iface {
    ...
    public IAsyncResult Begin_sendDisplay(AsyncCallback callback, object state, int width, int height, int barHeight, int scale)
    {
      return send_sendDisplay(callback, state, width, height, barHeight, scale);
    }
    ...
    {
      #if SILVERLIGHT
      var asyncResult = Begin_sendDisplay(null, null, width, height, barHeight, scale);
      return End_sendDisplay(asyncResult);

      #else
      send_sendDisplay(width, height, barHeight, scale);
      return recv_sendDisplay();

      #endif
    }
    #if SILVERLIGHT
    public IAsyncResult send_sendDisplay(AsyncCallback callback, object state, int width, int height, int barHeight, int scale)
    {
    ...
    public void send_sendDisplay(int width, int height, int barHeight, int scale)
    {
      oprot_.WriteMessageBegin(new TMessage("sendDisplay", TMessageType.Call, seqid_));
      sendDisplay_args args = new sendDisplay_args();
      args.Width = width;
    ...
    public IAsyncResult Begin_sendPoint(AsyncCallback callback, object state, int x, int y)
    {
      return send_sendPoint(callback, state, x, y);
    }

    public string End_sendPoint(IAsyncResult asyncResult)
    {
      oprot_.Transport.EndFlush(asyncResult);
    ...
    {
      #if SILVERLIGHT
      var asyncResult = Begin_sendPoint(null, null, x, y);
    ...
    #if SILVERLIGHT
    public IAsyncResult send_sendPoint(AsyncCallback callback, object state, int x, int y)
    {
    ...
    public void send_sendPoint(int x, int y)
    {
      oprot_.WriteMessageBegin(new TMessage("sendPoint", TMessageType.Call, seqid_));
      sendPoint_args args = new sendPoint_args();
      args.X = x;
  ...
  public class Processor : TProcessor {
    ...
    public void sendDisplay_Process(int seqid, TProtocol iprot, TProtocol oprot)
    {
      ...
      try
      {
        result.Success = iface_.sendDisplay(args.Width, args.Height, args.BarHeight, args.Scale);
    ...
    public void sendPoint_Process(int seqid, TProtocol iprot, TProtocol oprot)
    {
      ...
      try
      {
        result.Success = iface_.sendPoint(args.X, args.Y);
